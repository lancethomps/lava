...
public class ChecksTest extends BaseTest {
  ...
  public void testDoAnyExpressionsMatch() throws Exception {
    ...
    Assert.assertFalse(Checks
      .doAnyExpressionsMatch(Arrays.asList(new OutputExpression().setExpression("['key'] == null")), rootObject)
      .testMatched());

    Assert.assertTrue(
      Checks
        .doAnyExpressionsMatchUsingRootWrapper(
          Arrays.asList(new OutputExpression().setExpression("data['key'] != null")),
          rootObject,
