...
/**
 * The Class OrderedMapSerializer.
 */
public class CustomOrderedKeysMapSerializer extends MapSerializer {
	...
	/**
	 * Instantiates a new ordered map serializer.
	 *
	 * @param src the src
	 ...
	 */
	protected CustomOrderedKeysMapSerializer(MapSerializer src, BeanProperty property,
	 ...
	 * @param src the src
	 * @param vts the vts
	 * @param suppressableValue the suppressable value
	 * @param suppressNulls the suppress nulls
	 */
