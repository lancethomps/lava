...
/**
 * The Class QueryStringToMapParser.
 */
		...
		if (paramName.endsWith("*")) {
			...
			for (String param : request.get(paramName)) {
				Map<String, List<String>> subMap = Serializer.isJsonObject(param)
					? Serializer.fromJson(param, Serializer.constructMapType(HashMap.class, String.class, Serializer.constructCollectionType(ArrayList.class, String.class)))
